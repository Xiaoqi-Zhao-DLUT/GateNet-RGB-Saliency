...
from model.GateNetv2_rgb_vgg16 import GateNet_v2
import ttach as tta
...
args = {
    'snapshot': 'GateNetv2_vgg16_DBD_train_strategy2_mstrain_batch8_100epochModel_100_gen',
    'crf_refine': False,
    'save_results': True
}
    ...
    with torch.no_grad():
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                rgb_jpg_path = os.path.join(root, 'image', img_name[0] + '.jpg')
                rgb_bmp_path = os.path.join(root, 'image', img_name[0] + '.bmp')
