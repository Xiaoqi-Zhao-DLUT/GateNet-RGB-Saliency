...
from utils.dataset_rgbd_strategy2 import get_loader
...
# build models
generator = GateNetv2_two_stream()
generator.cuda()
...
for epoch in range(1, opt.epoch+1):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            with amp.autocast(enabled=use_fp16):
                output_fpn, output_final = generator.forward(images,depths)  # hed
    ...
    save_path = './saved_model/GateNetv2_two_stream'
